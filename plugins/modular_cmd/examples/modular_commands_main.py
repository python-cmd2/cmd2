...
from cmd2_modular_cmds import CommandSet, ModularCommandsMixin
...
class WithModularCommands(ModularCommandsMixin, Cmd):
...
if __name__ == '__main__':
    ...
    app = WithModularCommands(command_sets=my_sets)
