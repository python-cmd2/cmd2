...
setuptools.setup(
    ...
    description='Modular commands plugin for cmd2. Allows for commands to be defined in individual modules instead'
                ' of a single god class containing all possible commands.',
