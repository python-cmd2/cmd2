"""Provides a StrEnum of Rich's named colors.

This module defines the Cmd2Color enumeration, which contains a comprehensive list
of all named colors supported by the Rich library. These colors can be used for
both foreground and background styling. Using this enum instead of string literals
prevents typos and enables IDE autocompletion, which makes it easier to discover
and use the available colors.
"""
...
class Cmd2Color(StrEnum):
    """A comprehensive enumeration of all Rich's named colors."""
