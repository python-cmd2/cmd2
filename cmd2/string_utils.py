...
def align_string(
    ...
    """
    if width is None:
        width = rich_utils.console_width()

    text = rich_utils.from_ansi(val)
    text.align(align, width=width, character=character)
    return rich_utils.rich_text_to_string(text)
...
def align_left(
    ...
    """
    return align_string(val, "left", width=width, character=character)
...
def align_center(
    ...
    """
    return align_string(val, "center", width=width, character=character)
...
def align_right(
    ...
    """
    return align_string(val, "right", width=width, character=character)
...
def quote_string_if_needed(val: str) -> str:
